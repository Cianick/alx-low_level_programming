...
# Create 101-print_listint_safe.c
...
# Create 102-free_listint_safe.c
...
# Apply Betty style to all the created files
betty *.c *.h

echo "All files created and formatted with Betty style."
